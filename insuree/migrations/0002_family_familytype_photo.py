    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "poverty",
                    models.BooleanField(blank=True, db_column="Poverty", null=True),
                ),
                (
                    "address",
                    models.CharField(
                        blank=True, db_column="FamilyAddress", max_length=200, null=True
                    ),
                ),
                (
                    "is_offline",
                ...
                (
                    "ethnicity",
                    models.CharField(
                        blank=True, db_column="Ethnicity", max_length=1, null=True
                    ),
                ),
                (
                    "confirmation_no",
                    models.CharField(
                        blank=True, db_column="ConfirmationNo", max_length=12, null=True
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id",
                    models.AutoField(
                        db_column="PhotoID", primary_key=True, serialize=False
                    ),
                ),
                (
                    "insuree_id",
                    models.IntegerField(blank=True, db_column="InsureeID", null=True),
                ),
                (
                    "chf_id",
                    models.CharField(
                        blank=True, db_column="CHFID", max_length=12, null=True
                    ),
                ),
                ...
                (
                    "filename",
                    models.CharField(
                        blank=True, db_column="PhotoFileName", max_length=250, null=True
                    ),
                ),
