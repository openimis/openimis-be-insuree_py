        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id",
                    models.AutoField(
                        db_column="InsureeID", primary_key=True, serialize=False
                    ),
                ),
                (
                    "legacy_id",
                ...
                (
                    "marital",
                    models.CharField(
                        blank=True, db_column="Marital", max_length=1, null=True
                    ),
                ),
                ...
                (
                    "geolocation",
                    models.CharField(
                        blank=True, db_column="GeoLocation", max_length=250, null=True
                    ),
                ),
                (
                    "current_village",
                ...
                (
                    "photo_date",
                    core.fields.DateField(blank=True, db_column="PhotoDate", null=True),
                ),
